...
<body>
    <div class="container pt-0 mt-0 pb-4 mb-4">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse animate__animated animate__backInRight animation"
        ...
        <div class="row mt-4">
            <div class="col-md-6 col-sm-12 mt-4 pt-4">
                ...
                <h3
                    class="text-white text-center mb-4 sub-heading pb-4 animate__animated animate__backInDown animation">
                    Begin your moments with us!</h3>
                <div
                    class="card-transparent card-cus px-0 py-0 mt-4 shadow animate__animated animate__bounceInLeft animation">
